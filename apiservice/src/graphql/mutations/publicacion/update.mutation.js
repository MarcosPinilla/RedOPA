import { GraphQLString, graphql, GraphQLNonNull, GraphQLID, GraphQLBoolean, GraphQLInt } from "graphql"
...
const updatePublicacion = {
  ...
  async resolve (root, { publicacion_id, titulo, contenido, fecha, foto, interes_id, visibilidad }, { me }) {
    ...
    if (interes_id !== null && interes_id > 0) {
