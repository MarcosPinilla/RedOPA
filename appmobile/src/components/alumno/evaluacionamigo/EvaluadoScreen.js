...
import EvaluacionAmigoMutation from './EvaluacionAmigoMutation';
...
const EvaluadoScreen = (props) => {
  ...
  return (
    <ScrollView style={styles.background}>
      <Text style={styles.titleText}>¿Cómo evalúas a tu amigo?</Text>
      <View style={styles.container}>
        ...
        <View style={styles.item}>
          ...
          <EvaluacionAmigoMutation idAlumno={idAlumno} idEmocion={1} permanente={false} puede= {false} navigation={props.navigation} goTo={goTo} titulo="Feliz"/>
        </View>
        <View style={styles.item}>
          <Image source={require('../../../../assets/emotes/emoji_cool.gif')} style={{width:60,height:60}}></Image>
          <EvaluacionAmigoMutation idAlumno={idAlumno} idEmocion={2} permanente={false} puede= {false} navigation={props.navigation} goTo={goTo} titulo="Piola"/>
        </View>
        <View style={styles.item}>
          <Image source={require('../../../../assets/emotes/emoji_indecisive.gif')} style={{width:60,height:60}}></Image>
          <EvaluacionAmigoMutation idAlumno={idAlumno} idEmocion={3} permanente={false} puede= {false} navigation={props.navigation} goTo={goTo} titulo="Indecis@"/>
        </View>
        <View style={styles.item}>
          <Image source={require('../../../../assets/emotes/emoji_indifferent.gif')} style={{width:60,height:60}}></Image>
          <EvaluacionAmigoMutation idAlumno={idAlumno} idEmocion={4} permanente={false} puede= {false} navigation={props.navigation} goTo={goTo} titulo="Indiferente"/>
        </View>
        <View style={styles.item}>
          <Image source={require('../../../../assets/emotes/emoji_angry.gif')} style={{width:60,height:60}}></Image>
          <EvaluacionAmigoMutation idAlumno={idAlumno} idEmocion={5} permanente={false} puede= {false} navigation={props.navigation} goTo={goTo} titulo="Enojad@"/>
        </View>
        <View style={styles.item}>
          <Image source={require('../../../../assets/emotes/emoji_troubled.gif')} style={{width:60,height:60}}></Image>
          <EvaluacionAmigoMutation idAlumno={idAlumno} idEmocion={6} permanente={false} puede= {false} navigation={props.navigation} goTo={goTo} titulo="Cansad@"/>
        </View>
        <View style={styles.item}>
          <Image source={require('../../../../assets/emotes/emoji_sad.gif')} style={{width:60,height:60}}></Image>
          <EvaluacionAmigoMutation idAlumno={idAlumno} idEmocion={7} permanente={false} puede= {false} navigation={props.navigation} goTo={goTo} titulo="Triste"/>
        </View>
      </View>
    </ScrollView>
  )
