...
import ResultNoAmigosSearchQuery from './../../../components/personalizar/amigos/ResultNoAmigosSearchQuery';
import NoAmigos from './../../../components/personalizar/amigos/NoAmigosQuery';

const AmigosScreen = (props) => {

  const { goTo, handleChange, showDialog, hideDialog, visible, recargarAmigos, nombre,  } = props;
    ...
    <View style={styles.container}>
      ...
      <Card style= { styles.card }>
        <View style={ styles.subtitleContainer }>
          <Text style={ styles.subtitle }>Selecciona cinco amigos en <Text style={ styles.orden }>orden de amistad</Text></Text>
        </View>
