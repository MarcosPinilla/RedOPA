...
import ContactosQuery from './../../../components/personalizar/contactos/ContactosQuery';
import NoContactosQuery from './../../../components/personalizar/contactos/NoContactosQuery';
import NoContactosSearch from './../../../components/personalizar/contactos/NoContactosSearchQuery';

const ContactosScreen = (props) => {

  const { handleChange, showDialog, hideDialog, visible, recargarContactos, nombre, textSearch, setTextSearch } = props;
