...
const FotoScreen = (props) => {
  ...
  const _chooseImage = async () => {
    ...
    let fotoData = '';
    if (result.uri.match(/.jpg/)) {
      fotoData = 'data:image/jpeg;base64,' + result.base64;
    } else if (result.uri.match(/.png/)) {
      fotoData = 'data:image/png;base64,' + result.base64;
    }   
  ...
  return (
    <View style={styles.container}>
      <View style={ styles.titleContainer }>
        <Text style={ styles.title }>Cuéntanos, ¿cómo te gusta que <Text style={ styles.digan }>te vean</Text>?</Text>
      </View>
      ...
      <Card style= { styles.card }>
        ...
        <Card.Content>
          ...
          <View style={ styles.subtitleContainer }>
            <Text style={ styles.subtitle }>(¡Psst! Sube una foto tuya, que no se te olvideasdasd)</Text>
          </View>
        </Card.Content>
      </Card>
