...
function renderEmoji (idEmocion){
  if(idEmocion === 1){
    return (
      <View>
        <Text style={{fontSize:30, marginBottom: 25, marginTop:10}}>Muchas Gracias por Evaluar a tu Pupilo!!!</Text>
...
const EvaluacionPupiloCompleta = (props) => {
  ...
  return(
    <View style={{flex: 1 , backgroundColor: "#F6F6F6", width: '100%'}}>
      <Text style={{fontSize:25, alignSelf: 'center', fontFamily: 'niramit-regular', marginTop:25}}>Evaluaste a tu pupilo:</Text>
      <View style={{ flex:2, margin: 25,  backgroundColor:'#FFFFFF', borderRadius: 25, alignItems:'center'}}>
        ...
        <Button
          ...
          style= {styles.button}
          onPress={() => {
            props.navigation.navigate('EvaluacionPupilo')
          }}
        >
...
export default EvaluacionPupiloCompleta;