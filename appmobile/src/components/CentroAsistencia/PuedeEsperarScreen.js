...
const PuedeEsperarScreen = (props) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.subtitle}>¿Tu pena puede esperar?</Text>
        <Divider style={styles.divider}></Divider>
        <Button
          style={styles.noButton}
          onPress={()=> props.navigation.navigate('SaludRespondeScreen', {props})}
        >
          <Text style={styles.textNoButton}>No, no puede esperar</Text>
        </Button>
        <Button
          style={styles.siButton}
          onPress={()=> props.navigation.navigate('ConvivenciaScreen', {props})}
        >
          <Text style={styles.textSiButton}>Sí, puede esperar</Text>
        </Button>
      </View>
    </View>
  )
...
export default PuedeEsperarScreen;